...
parse_object_flag_description<Mission::Parse_Object_Flags> Parse_object_flag_descriptions[] = {
    { Mission::Parse_Object_Flags::SF_Cargo_known,					"If set, the ships cargo can be seen without scanning the ship."},
    ...
    { Mission::Parse_Object_Flags::AIF_No_dynamic,					"Will stop allowing the AI to persue dynamic goals (eg: chasing ships it was not ordered to)."},
    ...
    { Mission::Parse_Object_Flags::SF_Friendly_stealth_invis,		"If set, the ship can't be targeted even by ships on the same team."},
    ...
    { Mission::Parse_Object_Flags::SF_Affected_by_gravity,			"Ship is affected by mission gravity."},
    ...
    { Mission::Parse_Object_Flags::OF_Targetable_as_bomb,			"Allows ship to be targetted with the bomb targetting key."},
    ...
    { Mission::Parse_Object_Flags::OF_Immobile,						"Will not let a ship move or rotate in any fashion."},
    ...
    { Mission::Parse_Object_Flags::SF_Same_arrival_warp_when_docked,"Docked ships use the same warp effect upon arrival."},
    { Mission::Parse_Object_Flags::SF_Same_departure_warp_when_docked,"Docked ship use the same warp effect upon departure."},
