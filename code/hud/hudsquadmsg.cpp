...
void hud_squadmsg_type_select( )
{
	...
	if (Ai_info[Ships[Player_obj->instance].ai_index].ai_flags[AI::AI_Flags::Being_repaired] ||
		Ai_info[Ships[Player_obj->instance].ai_index].ai_flags[AI::AI_Flags::Awaiting_repair]) {
