...
ADE_VIRTVAR(Velocity, l_Physics, "vector", "Object world velocity (World vector). Setting this value will have minimal effect unless the $Scriped velocity game settings flag is used.", "vector", "Object velocity, or null vector if handle is invalid")
{
	physics_info_h *pih;
	vec3d *v3=NULL;
	if(!ade_get_args(L, "o|o", l_Physics.GetPtr(&pih), l_Vector.GetPtr(&v3)))
