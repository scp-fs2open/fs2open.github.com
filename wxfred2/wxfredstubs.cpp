/*
 * Created by z64555 for the FreeSpace Source Code project.
 *
 * This is a derivative work of Volition Inc.'s Freespace 2 Editor (FRED2)
 * You may not sell or otherwise commercially exploit the source or things you
 * created based on the source.
 */

/**
 * File of deprecated data members and functions.
 *
 * There's a number of references within the FreeSpace 2 Open codebase that link to files and objects within the main
 * executable. Since FRED2 (and likewise wxFRED2) currently has no need of these, they must be re-defined within the
 * scope of the wxFRED2 objects.
 */
