...
//**********HANDLE: Asteroid
ade_obj<object_h> l_Asteroid("asteroid", "Asteroid handle", &get_l_Object());
...
//**********HANDLE: Debris
ade_obj<object_h> l_Debris("debris", "Debris handle", &get_l_Object());
...
//**********HANDLE: Waypoint
ade_obj<object_h> l_Waypoint("waypoint", "waypoint handle", &get_l_Object());
