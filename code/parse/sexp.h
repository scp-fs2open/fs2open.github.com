...
// #define OP_SCRIPT_EVAL_STRING				(0x002b | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG) // WMCoolmon
...
#define OP_SCRIPT_EVAL_STRING				(0x001f | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)	// WMCoolmon
#define OP_TECH_ADD_INTEL_XSTR				(0x0020 | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)	// Goober5000
