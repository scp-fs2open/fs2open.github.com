...
// Returns whether a model instance with this number currently exists.  Use this before acting on an instance number that
// was stored earlier, since instances can be deleted (and their numbers reused) at any time.
extern bool model_instance_exists(int model_instance_num);
