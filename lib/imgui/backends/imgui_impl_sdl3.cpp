...
bool ImGui_ImplSDL3_ProcessEvent(const SDL_Event* event)
{
    ...
    switch (event->type)
    {
        ...
        // - In some cases, when detaching a window from main viewport SDL may send SDL_EVENT_WINDOW_ENTER one frame too late,
        //   causing SDL_EVENT_WINDOW_LEAVE on previous frame to interrupt drag operation by clear mouse position. This is why
        //   we delay process the SDL_EVENT_WINDOW_LEAVE events by one frame. See issue #5012 for details.
