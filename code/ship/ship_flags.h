...
namespace Ship {
	...
	FLAG_LIST(Info_Flags) {
		...
		No_impact_shards,				// wookieejedi - Don't spawn the small debris shards on impact
		No_explosion_shards,           // wookieejedi - Don't spawn the small debris shards on explosion
