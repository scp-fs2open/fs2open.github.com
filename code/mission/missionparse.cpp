...
parse_object_flag_description<Mission::Parse_Object_Flags> Parse_object_flag_descriptions[] = {
    ...
    { Mission::Parse_Object_Flags::SF_Same_arrival_warp_when_docked,"Docked ships use the same warp effect size upon arrival as if they were not docked instead of the enlarged arggregate size."},
    { Mission::Parse_Object_Flags::SF_Same_departure_warp_when_docked,"Docked ship use the same warp effect size upon departure as if they were not docked instead of the enlarged arggregate size."},
