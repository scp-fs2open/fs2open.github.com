 ...
 * --Goober5000
 *
 * Revision 1.29  2006/01/15 00:48:25  Goober5000
 * this should complete the new IFF stuff for FRED
 * --Goober5000
 *
 * Revision 1.28  2006/01/14 23:49:01  Goober5000
 * second pass; all the errors are fixed now; one more thing to take care of
 * --Goober5000
 *
 * Revision 1.27  2006/01/14 05:24:18  Goober5000
 * first pass at converting FRED to use new IFF stuff
 * --Goober5000
 *
 * Revision 1.26  2005/12/29 08:21:00  wmcoolmon
 * No my widdle FRED, I didn't forget about you ^_^ (codebase commit)
 *
 * Revision 1.25  2005/10/29 23:02:33  Goober5000
 * partial FRED commit of changes
 * --Goober5000
 *
 * Revision 1.24  2005/09/26 03:37:34  Goober5000
 * species upgrade stuff for FRED
 * --Goober5000
 *
 * Revision 1.23  2005/09/10 01:53:43  phreak
 ...
 *
 * Revision 1.22  2005/08/23 07:28:02  Goober5000
 * grammar
 * --Goober5000
 *
 * Revision 1.21  2005/07/13 01:03:10  Goober5000
 * improved species support and removed need for #define
 * --Goober5000
 *
 * Revision 1.20  2005/04/13 20:11:06  chhogg
 * Changed vector to vec3d for Fred.
 *
 * Revision 1.19  2005/03/29 03:43:11  phreak
 * ai directory fixes as well as fixes for the new jump node code
 *
 * Revision 1.18  2005/03/20 23:49:24  phreak
 * make sure the presence of a jump node doesn't throw an unknown object type error
 *
 * Revision 1.17  2005/03/06 22:39:59  wmcoolmon
 * Fixx0red some of the jump node errors
 *
 * Revision 1.16  2005/01/29 06:28:15  Goober5000
 * bugfixes
 * --Goober5000
 *
 * Revision 1.15  2005/01/29 05:40:27  Goober5000
 ...
 * --Goober5000
 *
 * Revision 1.13  2004/11/04 01:41:00  Goober5000
 ...
 * Added check to global error checker to make sure player wing exists for
