                ...
                if (Render_subsys.do_render)
                {
                    ...
                    if (Cmdline_nohtl)
                    {
                        ...
                        if (get_subsys_bounding_rect(objp, Render_subsys.cur_subsys, &x1, &x2, &y1, &y2))
                        {
                            ...
                            // draw box
                            gr_line(x1, y1, x1, y2);
                            gr_line(x1 - 1, y1, x1 - 1, y2);
                            gr_line(x1, y2, x2, y2);
                            gr_line(x1, y2 + 1, x2, y2 + 1);
                            gr_line(x2, y2, x2, y1);
                            gr_line(x2 + 1, y2, x2 + 1, y1);
                            gr_line(x2, y1, x1, y1);
                            gr_line(x2, y1 - 1, x1, y1 - 1);
...
namespace fso
{
    namespace fred
    {
        ...
        */
        ...
        void FredRenderer::display_ship_info(
        ...
        void FredRenderer::render_one_model_nohtl(
        ...
        void FredRenderer::render_one_model_htl(
            object* objp, int cur_object_index,
            bool Show_starts, bool Show_ships, bool Show_iff[],
            bool Bg_bitmap_dialog,
            bool Show_ship_models, bool Show_dock_points,
        ...
        void FredRenderer::render_models(
            int cur_object_index,
            bool Show_starts, bool Show_ships, bool Show_iff[],
            bool Bg_bitmap_dialog,
            ...
            bool Show_paths_fred, bool Lighting_on, bool FullDetail)
        {
            ...
            if (Cmdline_nohtl)
            {
                std::function<void(object*)> render_function(
                    std::bind(&FredRenderer::render_one_model_nohtl, this, std::placeholders::_1,
            ...
            else
            {
                ...
                std::function<void(object*)> render_function(
                    std::bind(&FredRenderer::render_one_model_htl, this, std::placeholders::_1,
                              cur_object_index, Show_starts, Show_ships, Show_iff,
        ...
        int FredRenderer::object_check_collision(
