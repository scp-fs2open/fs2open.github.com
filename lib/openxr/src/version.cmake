...
if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/../specification/registry/xr.xml")
    file(STRINGS ${CMAKE_CURRENT_LIST_DIR}/../specification/registry/xr.xml lines REGEX "#define <name>XR_CURRENT_API_VERSION")
else()
    file(STRINGS ${CMAKE_CURRENT_LIST_DIR}/../include/openxr/openxr.h lines REGEX "#define XR_CURRENT_API_VERSION")
endif()
