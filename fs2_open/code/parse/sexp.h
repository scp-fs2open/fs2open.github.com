...
#define OP_IS_AI_CLASS						(0x0022 | OP_CATEGORY_STATUS | OP_NONCAMPAIGN_FLAG)	// Goober5000
#define OP_IS_SHIP_TYPE						(0x0023 | OP_CATEGORY_STATUS | OP_NONCAMPAIGN_FLAG)	// Goober5000
#define OP_IS_SHIP_CLASS					(0x0024	| OP_CATEGORY_STATUS | OP_NONCAMPAIGN_FLAG)	// Goober5000
#define OP_NUM_SHIPS_IN_BATTLE				(0x0025 | OP_CATEGORY_STATUS | OP_NONCAMPAIGN_FLAG)	// phreak
#define OP_NAV_ISVISITED					(0x0026 | OP_CATEGORY_STATUS | OP_NONCAMPAIGN_FLAG)	// Kazan
#define OP_NAV_DISTANCE						(0x0027 | OP_CATEGORY_STATUS | OP_NONCAMPAIGN_FLAG)	// Kazan
#define OP_CURRENT_SPEED					(0x0028 | OP_CATEGORY_STATUS | OP_NONCAMPAIGN_FLAG) // WMCoolmon
#define OP_IS_IFF							(0x0029 | OP_CATEGORY_STATUS | OP_NONCAMPAIGN_FLAG)	// Goober5000
#define OP_NUM_WITHIN_BOX					(0x002a | OP_CATEGORY_STATUS | OP_NONCAMPAIGN_FLAG)	// WMCoolmon
...
#define OP_SET_OBJECT_FACING				(0x007f | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)	// Goober5000
#define OP_SET_OBJECT_FACING_OBJECT			(0x0080 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)	// Goober5000
#define OP_SET_OBJECT_POSITION				(0x0081	| OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)	// Goober5000
...
// WMC
#define OP_CUTSCENES_SET_CUTSCENE_BARS		(0x009d | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_UNSET_CUTSCENE_BARS	(0x009e | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_FADE_IN				(0x009f | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_FADE_OUT				(0x00a0 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_SET_CAMERA_POSITION	(0x00a1 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_SET_CAMERA_FACING		(0x00a2 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_SET_CAMERA_FACING_OBJECT	(0x00a3 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_SET_CAMERA_ROTATION	(0x00a4 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_SET_FOV				(0x00a5 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_RESET_FOV				(0x00a6 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_RESET_CAMERA			(0x00a7 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_SHOW_SUBTITLE			(0x00a8 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_SET_TIME_COMPRESSION	(0x00a9 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_RESET_TIME_COMPRESSION	(0x00aa | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_FORCE_PERSPECTIVE		(0x00ab | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)

// WMC
#define OP_JUMP_NODE_SET_JUMPNODE_NAME		(0x00ac | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_JUMP_NODE_SET_JUMPNODE_COLOR		(0x00ad | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_JUMP_NODE_SET_JUMPNODE_MODEL		(0x00ae | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_JUMP_NODE_SHOW_JUMPNODE			(0x00af | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_JUMP_NODE_HIDE_JUMPNODE			(0x00b0 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)

#define OP_SHIP_GUARDIAN_THRESHOLD			(0x00b1 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)	// Goober5000
#define OP_SHIP_SUBSYS_GUARDIAN_THRESHOLD	(0x00b2 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)	// Goober5000

#define OP_SET_SKYBOX_MODEL					(0x00b3 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG) // taylor

#define OP_SHIP_CREATE						(0X00b4 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_WEAPON_CREATE					(0x00b5	| OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)	// Goober5000
...
#define OP_ADD_BACKGROUND_BITMAP			(0x00ba | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_REMOVE_BACKGROUND_BITMAP			(0x00bb | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_ADD_SUN_BITMAP					(0x00bc | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_REMOVE_SUN_BITMAP				(0x00bd | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_NEBULA_CHANGE_STORM				(0x00be | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_NEBULA_TOGGLE_POOF				(0x00bf | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)

#define OP_TURRET_CHANGE_WEAPON				(0x00c0 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_TURRET_SET_TARGET_ORDER			(0x00c1 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_SHIP_TURRET_TARGET_ORDER			(0x00c2 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
