...
public:
	 ...
	 */
	void bindUniformBuffer(uniform_block_type blockType, size_t offset, size_t size, gr_buffer_handle buffer) const;
...
private:
	 ...
	 */
	static MemoryUsage getMemoryUsage(BufferUsageHint hint) ;
