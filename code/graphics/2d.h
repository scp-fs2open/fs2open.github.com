...
#define SDR_FLAG_MODEL_HANDLED_BY_UNIFORM \
	(SDR_FLAG_MODEL_DIFFUSE_MAP | SDR_FLAG_MODEL_GLOW_MAP | SDR_FLAG_MODEL_SPEC_MAP | SDR_FLAG_MODEL_LIGHT | SDR_FLAG_MODEL_DEFERRED | \
		SDR_FLAG_MODEL_HDR | \
