...
# ADD CPP /nologo /G5 /MT /W2 /GX /Zi /O2 /I "../../code" /I "../../oggvorbis/include" /I "../../dx8sdk/include" /I "../../lua" /I "../../openal/include" /D "_MBCS" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "USE_OPENAL" /D "NO_DIRECT3D" /U "_DEBUG" /FR /YX /FD /c
...
# ADD LINK32 Quartz.lib Dxerr8.lib d3d8.lib d3dx8.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib wsock32.lib winmm.lib vfw32.lib msacm32.lib comctl32.lib openal32.lib ogg_static.lib vorbis_static.lib vorbisfile_static.lib theora_static.lib /nologo /subsystem:windows /map /machine:I386 /nodefaultlib:"libc.lib" /nodefaultlib:"libcd.lib" /out:"Release/fs2_open_3_6_10.exe" /libpath:"Release" /libpath:"../../oggvorbis/lib" /libpath:"../../dx8sdk/lib" /libpath:"../../openal/libs/win32" /libpath:"../../openal/libs/win64" /MAPINFO:EXPORTS /MAPINFO:LINES
# SUBTRACT LINK32 /pdb:none /debug
# Begin Custom Build - Copying build...
IntDir=.\Release\Profile\freespace2
InputPath=.\Release\fs2_open_3_6_10.exe
SOURCE="$(InputPath)"

BuildCmds= \
	copy /y $(InputPath) "C:\games\freespace2\fs2_open_3_6_10.exe" \
	copy /y $(IntDir)\fs2_open_3_6_10.map "c:\games\freespace2\fs2_open_3_6_10.map" \
	

"c:\games\freespace2\fs2_open_3_6_10.exe" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"c:\games\freespace2\fs2_open_3_6_10.map" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
# End Custom Build
...
# ADD CPP /nologo /G5 /MTd /W4 /Gm /Gi /GX /ZI /Od /I "../../code" /I "../../oggvorbis/include" /I "../../dx8sdk/include" /I "../../lua" /I "../../openal/include" /D "_WINDOWS" /D "WIN32" /D "_DEBUG" /D "USE_OPENAL" /D "NO_DIRECT3D" /U "NDEBUG" /FR /YX /FD /GZ /GZ /c
...
# ADD LINK32 Quartz.lib d3d8.lib d3dx8.lib DxErr8.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib wsock32.lib winmm.lib vfw32.lib msacm32.lib comctl32.lib openal32.lib ogg_static.lib vorbis_static.lib vorbisfile_static.lib theora_static.lib /nologo /subsystem:windows /map /debug /debugtype:both /machine:I386 /nodefaultlib:"libc.lib" /nodefaultlib:"libcd.lib" /nodefaultlib:"libcmt.lib" /out:"Debug\fs2_open_3_6_10_debug.exe" /libpath:"Debug" /libpath:"../../oggvorbis/lib" /libpath:"../../dx8sdk/lib" /libpath:"../../openal/libs/win32" /libpath:"../../openal/libs/win64" /MAPINFO:EXPORTS /MAPINFO:LINES
# SUBTRACT LINK32 /pdb:none /incremental:no
# Begin Custom Build - Copying build...
IntDir=.\Debug\Profile\freespace2
InputPath=.\Debug\fs2_open_3_6_10_debug.exe
SOURCE="$(InputPath)"

BuildCmds= \
	copy /y $(InputPath) "c:\games\freespace2\fs2_open_3_6_10_debug.exe" \
	copy /y $(IntDir)\fs2_open_3_6_10_debug.map "c:\games\freespace2\fs2_open_3_6_10_debug.map" \
	

"c:\games\freespace2\fs2_open_3_6_10_debug.exe" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"c:\games\freespace2\fs2_open_3_6_10_debug.map" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
# End Custom Build
