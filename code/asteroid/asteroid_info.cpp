...
asteroid_info_parse_items::asteroid_info_parse_items()
{
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$POF file1:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$POF file2:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$POF file3:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Explosion Animations:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Explosion Radius Mult:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Expl inner rad:"))
		.set_description(SCP_string("Radius at which the full explosion damage is done, in meters."))
		.set_implementation_version(2, 0, 0)
		.set_type(Parse_Input_Types::FLOAT)
		.finished_product());

	_all_items.push_back(*factory->new_parse_item(SCP_string("$Expl outer rad:"))
		.set_description(SCP_string("Maximum radius at which any damage is done, in meters."))
		.set_implementation_version(2, 0, 0)
		.set_type(Parse_Input_Types::FLOAT)
		.finished_product());

	_all_items.push_back(*factory->new_parse_item(SCP_string("$Expl damage:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Expl blast:"))
		.set_description(SCP_string("The intensity of the blast effect when you're within the outer radius."))
		.set_implementation_version(2, 0, 0)
		.set_type(Parse_Input_Types::FLOAT)
		.finished_product());

	_all_items.push_back(*factory->new_parse_item(SCP_string("$Hitpoints:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Split:")).
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Min:"))
		.set_description(SCP_string("The minimum number of spawned asteroids. Default 0."))
		.set_implementation_version(3, 6, 15)
		.set_type(Parse_Input_Types::INT)
		.finished_product());

	_all_items.push_back(*factory->new_parse_item(SCP_string("+Max:"))
