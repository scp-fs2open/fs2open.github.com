 ...
 * --Goober5000
 *
 * Revision 1.19  2006/01/14 05:24:19  Goober5000
 * first pass at converting FRED to use new IFF stuff
 * --Goober5000
 *
 * Revision 1.18  2005/12/29 08:21:00  wmcoolmon
 * No my widdle FRED, I didn't forget about you ^_^ (codebase commit)
 *
 * Revision 1.17  2005/09/26 07:58:27  Goober5000
 * hooray, more custom wing fixes
 * --Goober5000
 *
 * Revision 1.16  2005/09/26 07:22:25  Goober5000
 * small tweak to finish the fix
 * --Goober5000
 *
 * Revision 1.15  2005/09/26 03:37:35  Goober5000
 ...
 * --Goober5000
 *
 * Revision 1.13  2005/07/15 21:07:01  Goober5000
 * fixed a bunch of stupid errors that never should have made it to CVS
 * --Goober5000
 *
 * Revision 1.12  2005/07/13 01:03:10  Goober5000
 * improved species support and removed need for #define
 * --Goober5000
 *
 * Revision 1.11  2005/06/29 19:00:25  taylor
 ...
 *
 * Revision 1.9  2005/03/06 22:43:14  wmcoolmon
 * Fixx0red some of the jump node errors
 *
 * Revision 1.8  2004/12/15 19:16:13  Goober5000
 * FRED code for custom wing names
 * --Goober5000
 *
 * Revision 1.7  2004/06/15 20:50:29  wmcoolmon
 * hud-set-color, current-speed, and FRED fixes (Wouldn't compile).
 *
 * Revision 1.6  2003/09/05 06:53:41  Goober5000
 * added code to change the player's ship in single player
 * --Goober5000
 *
 * Revision 1.5  2003/04/29 01:04:28  Goober5000
 * custom hitpoints for FRED
 * --Goober5000
 *
 * Revision 1.4  2003/03/25 07:03:29  Goober5000
 * added beginning functionality for $Texture Replace implementation in FRED
 * --Goober5000
 *
 * Revision 1.3  2002/12/17 03:16:11  DTP
 * made TBL button in initial_ship status, accisible while running a release build or debug build.
 *
