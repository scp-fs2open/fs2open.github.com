...
void control_config_common_init_bindings() {
	...
	(GLIDE_WHEN_PRESSED,                                     -1, -1, SHIP_TAB, 1799, "Glide When Pressed", CC_TYPE_CONTINUOUS)
	(TOGGLE_GLIDING,                          KEY_ALTED | KEY_G, -1, SHIP_TAB, 1800, "Toggle Gliding",     CC_TYPE_TRIGGER)
	...
	(CYCLE_PRIMARY_WEAPON_SEQUENCE,                       KEY_O, -1, WEAPON_TAB, 1801, "Cycle Primary Weapon Firing Rate",       CC_TYPE_TRIGGER)
	...
	(VIEW_TOPDOWN,                                           -1, -1, COMPUTER_TAB, 1802, "Top-Down View",                      CC_TYPE_TRIGGER)
	(VIEW_TRACK_TARGET,                                      -1, -1, COMPUTER_TAB, 1803, "Target Padlock View",                CC_TYPE_TRIGGER)
	...
	(AUTO_PILOT_TOGGLE,                       KEY_ALTED | KEY_A, -1, COMPUTER_TAB, 1804, "Toggle Auto Pilot",  CC_TYPE_TRIGGER)
	(NAV_CYCLE,                               KEY_ALTED | KEY_N, -1, COMPUTER_TAB, 1805, "Cycle Nav Points",   CC_TYPE_TRIGGER)
	...
	(TOGGLE_HUD_SHADOWS,                              KEY_ALTED | KEY_L, -1, COMPUTER_TAB, 1806, "Toggle HUD Drop Shadows",          CC_TYPE_TRIGGER)
