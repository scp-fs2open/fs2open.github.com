...
typedef struct screen {
	...
	std::function<void(matrix4* shadow_view_matrix, const matrix* light_matrix, vec3d* eye_pos, bool render_cockpit_cascades, bool render_scene_cascades, bool first_pass)> gf_shadow_map_start;
