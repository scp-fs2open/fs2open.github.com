...
namespace Ship {
	...
	FLAG_LIST(Ship_Flags) {
		...
		NUM_VALUES				// The E - Needs to be last

	};
	typedef flagset<Ship_Flags> ship_flags;

	inline bool is_ship_arriving(ship* shipp) { return shipp->flags[Ship_Flags::Arriving_stage_1] || shipp->flags[Ship_Flags::Arriving_stage_2]; }
	inline bool is_ship_departing(ship* shipp) { return shipp->flags[Ship_Flags::Depart_warp] || shipp->flags[Ship_Flags::Depart_dockbay]; }
	...
	inline bool is_small_ship(ship_info* sip) { return sip->flags[Info_Flags::Fighter] || sip->flags[Info_Flags::Bomber] || sip->flags[Info_Flags::Support] || sip->flags[Info_Flags::Escapepod]; }
	inline bool is_big_ship(ship_info* sip) { return sip->flags[Info_Flags::Cruiser] || sip->flags[Info_Flags::Freighter] || sip->flags[Info_Flags::Transport] || sip->flags[Info_Flags::Corvette] || sip->flags[Info_Flags::Gas_miner] || sip->flags[Info_Flags::Awacs]; }
	inline bool is_huge_ship(ship_info* sip) { return sip->flags[Info_Flags::Capital] || sip->flags[Info_Flags::Supercap] || sip->flags[Info_Flags::Drydock] || sip->flags[Info_Flags::Knossos_device]; }
	inline bool is_flyable(ship_info* sip) { return !(sip->flags[Info_Flags::Cargo] || sip->flags[Info_Flags::Navbuoy] || sip->flags[Info_Flags::Escapepod]); }
	...
	inline bool apply_beam_jitter(ship_info* sip) {
		return sip->flags[Info_Flags::Cargo] || sip->flags[Info_Flags::Fighter] || sip->flags[Info_Flags::Bomber] || sip->flags[Info_Flags::Freighter] || sip->flags[Info_Flags::Transport] || sip->flags[Info_Flags::Sentrygun] || sip->flags[Info_Flags::Navbuoy] || sip->flags[Info_Flags::Escapepod];
	}
