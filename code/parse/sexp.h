...
#define OP_HUD_SET_CUSTOM_GAUGE_ACTIVE		(0x0025 | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG) 	// The E, just revamped a bit by Axem
#define OP_HUD_SET_RETAIL_GAUGE_ACTIVE		(0x0026 | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG) 	// The E, just revamped a bit by Axem
#define OP_SCRIPT_EVAL_MULTI				(0x0027 | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)	// Karajorma
#define OP_PAUSE_SOUND_FROM_FILE			(0x0028 | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)	// Goober5000
#define OP_SCRIPT_EVAL_BLOCK				(0x0029 | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG) // niffiwan
#define OP_BEAM_FLOATING_FIRE				(0x002a | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)	// MageKing17
#define OP_TURRET_SET_PRIMARY_AMMO			(0x002b | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)	// DahBlount, part of the turret ammo changes
#define OP_TURRET_SET_SECONDARY_AMMO		(0x002c | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)	// DahBlount, part of the turret ammo changes
#define OP_JETTISON_CARGO_NEW				(0x002d | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)	// Goober5000
#define OP_STRING_CONCATENATE_BLOCK			(0x002e | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)	// Goober5000
#define OP_MODIFY_VARIABLE_XSTR				(0X002f | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)	// m!m

#define OP_RESET_POST_EFFECTS				(0x0030 | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)	// Goober5000
#define OP_ADD_REMOVE_HOTKEY				(0x0031 | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)    // wookieejedi
#define OP_TECH_REMOVE_INTEL_XSTR			(0x0032 | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)    // wookieejedi
#define OP_TECH_REMOVE_INTEL				(0x0033 | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)   // wookieejedi
#define OP_CHANGE_BACKGROUND				(0x0034 | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)	// Goober5000
