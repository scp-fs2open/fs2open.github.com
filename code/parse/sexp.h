...
#define OP_ADD_TO_COLGROUP_NEW				(0x0038 | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)	// Goober5000
#define OP_REMOVE_FROM_COLGROUP_NEW			(0x0039 | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)	// Goober5000
...
#define OP_TOGGLE_ASTEROID_FIELD			(0x0059 | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)	// MjnMixael
#define OP_HUD_FORCE_SENSOR_STATIC			(0x005a | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)	// MjnMixael
...
#define OP_SET_ASTEROID_FIELD				(0x005d | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)	// MjnMixael
#define OP_SET_DEBRIS_FIELD					(0x005e | OP_CATEGORY_CHANGE2 | OP_NONCAMPAIGN_FLAG)	// MjnMixael
