...
#define OP_CUTSCENES_FADE_OUT				(0x00a1 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_SET_CAMERA_POSITION	(0x00a2 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_SET_CAMERA_FACING		(0x00a3 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_SET_CAMERA_FACING_OBJECT	(0x00a4 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_SET_CAMERA_ROTATION	(0x00a5 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_SET_FOV				(0x00a6 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_RESET_FOV				(0x00a7 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_RESET_CAMERA			(0x00a8 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_SHOW_SUBTITLE			(0x00a9 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_CUTSCENES_SET_TIME_COMPRESSION	(0x00aa | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
...
#define OP_WEAPON_CREATE					(0x00b6	| OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)	// Goober5000

#define OP_SET_OBJECT_SPEED_X				(0X00b7 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_SET_OBJECT_SPEED_Y				(0X00b8 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_SET_OBJECT_SPEED_Z				(0X00b9 | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)

#define OP_MISSION_SET_NEBULA				(0x00ba | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
