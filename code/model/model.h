...
int model_load(const char *filename, int n_subsystems, model_subsystem *subsystems, ErrorType error_type = ErrorType::FATAL_ERROR, bool allow_redundant_load = false);
