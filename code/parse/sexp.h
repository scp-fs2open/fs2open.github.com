...
#define OP_GET_OBJECT_SPEED_X				(0X00ed | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_GET_OBJECT_SPEED_Y				(0X00ee | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
#define OP_GET_OBJECT_SPEED_Z				(0X00ef | OP_CATEGORY_CHANGE | OP_NONCAMPAIGN_FLAG)
