...
namespace animation {
	...
	void ModelAnimationMoveableOrientation::update(polymodel_instance* pmi, const SCP_vector<linb::any>& args) {
		if(args.size() < 3){
	...
	void ModelAnimationMoveableRotation::update(polymodel_instance* pmi, const SCP_vector<linb::any>& args) {
		if(args.size() < 3){
	...
	void ModelAnimationMoveableTranslation::update(polymodel_instance* pmi, const SCP_vector<linb::any>& args) {
		if(args.size() < 3){
	...
	void ModelAnimationMoveableAxisRotation::update(polymodel_instance* pmi, const SCP_vector<linb::any>& args) {
		if(args.empty()){
	...
	void ModelAnimationMoveableIK::update(polymodel_instance* pmi, const SCP_vector<linb::any>& args) {
		if(args.size() < 3){
