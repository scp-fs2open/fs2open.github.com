 ...
 * $Revision: 2.47.2.2 $
 * $Date: 2006-09-08 06:07:59 $
 * $Author: taylor $
 *
 * C file for all the UI controls of the mulitiplayer screens
 *
 * $Log: not supported by cvs2svn $
 * Revision 2.47.2.1  2006/08/03 17:55:01  karajorma
 ...
 *
 * Revision 2.34  2005/02/23 04:55:09  taylor
...
void multi_join_game_init()
{
	...
	if (Om_tracker_flag)
	{
		...
		Kaz_NoBackGround_DrawString("Connecting to Fs2NetD");
		fs2netd_maybe_init();

		if (!FS2OpenPXO_Socket.isInitialized())
		{	
			gamesnd_play_iface(SND_GENERAL_FAIL);
			popup(PF_USE_AFFIRMATIVE_ICON,1,POPUP_OK,"Connection Failed");
