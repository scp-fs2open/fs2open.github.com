...
Flag exe_params[] = 
{
	...
	{ "-use_new_collision",	"Use new per-triangle collision",			true,	0,									EASY_DEFAULT,					"Experimental", "", },
...
cmdline_parm use_new_collision_arg("-use_new_collision", nullptr, AT_NONE);
...
bool Cmdline_use_triangle_collision = false;
...
// Sets externed variables used for communication cmdline information
{
	...
	if (use_new_collision_arg.found()) {
