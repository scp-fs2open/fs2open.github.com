...
void batching_add_laser(int texture, vec3d *p0, float width1, vec3d *p1, float width2, int r = 255, int g = 255, int b = 255, int texture2 = -1, float switchover_ang = -1.0f, float switchover_rate = 2.0f);
