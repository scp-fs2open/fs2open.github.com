...
ship_info_parse_items::ship_info_parse_items() 
{
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+nocreate"))
	...
	// not on wiki
	_all_items.push_back(*factory->new_parse_item(SCP_string("+remove"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Use Template:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Alt name:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Display Name:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Short name:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Species:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Type:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Maneuverability:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Armor:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Manufacturer:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Description:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Tech Title:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Tech Description:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Length:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Gun Mounts:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Missile Banks:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Selection Effect:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Cockpit POF file:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Cockpit Offset:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Cockpit Display:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Texture:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Offsets:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Size:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Background:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Foreground:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("POF file:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("POF file Techroom:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Texture Replace:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+old:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+new:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$POF Target File:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$POF Target LOD:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Detail Distance:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Collision LOD:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$ND:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Enable Team Colors:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Default Team:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Show Damage:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Damage Lighting Type:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Impact:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Damage Type:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Impact Spew:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Max particles:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Min particles:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Max Radius:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Min Radius:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Man Lifetime:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Min Lifetime:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Max Velocity:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Min Velocity:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Normal Variance:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Damage Spew:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Collision Physics:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Bounce:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Both Small Bounce:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Friction:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Rotation Factor:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Landing Max Forward Vel:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Landing Min Forward Vel:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Landing Max Descent Vel:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Landing Max Horizontal Vel:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Landing Max Angle:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Landing Min Angle:"))
		.set_description(SCP_string("Maximum angle of attack the ship can land at (in degrees)."))
		.set_type(Parse_Input_Types::FLOAT)
		.set_implementation_version(3, 6, 14)
		.finished_product());
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Landing Max Rotate Angle:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Reorient Max Forward Vel:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Reorient Min Forward Vel:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Reorient Max Descent Vel:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Reorient Max Horizontal Vel:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Reorient Max Angle:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Reorient Min Angle:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Reorient Max Rotate Angle:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Reorient Speed Mult:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Landing Rest Angle:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Landing Sound:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Collision Sound Light:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Collision Sound Heavy:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Collision Sound Shielded:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Debris:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Max Lifetime:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Min Speed:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Max Speed:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Min Rotation speed:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Max Rotation speed:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Min Hitpoints:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Max Hitpoints:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Damage Multiplier:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Lightning Arc Percent:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Ambient Sound:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("+Explosion Sound:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Density:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Damp:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Rotdamp:"))
	...
	_all_items.push_back(*factory->new_parse_item(SCP_string("$Banking Constant:"))
