...
_major_version_number_deprecated		// int, -1 unless this option was actually deprecated.
_minor_version_number_deprecated		// int, -1 unless this option was actually deprecated.
_revision_number_deprecated				// int, -1 unless this option was actually deprecated.
_deprecation_message					// string why was this deprecated??
*/

table_manager Ai_class_parse_items;
...
void init_ai_class_parse_items()
{
	...
	parse_item_builder::set_table_type(&Ai_class_parse_items, Table_Types::AI);
	...
	factory->new_parse_item(SCP_string("$Name:"))
		...
		->finished_product(&Ai_class_parse_items);

	factory->new_parse_item(SCP_string("$Accuracy:"))
	...
	factory->new_parse_item(SCP_string("$Evasion:"))
	...
	factory->new_parse_item(SCP_string("$Courage:"))
	...
	factory->new_parse_item(SCP_string("$Patience:"))
	...
	factory->new_parse_item(SCP_string("Usage Note"))
	...
	factory->new_parse_item(SCP_string("$Afterburner Use Factor:"))
	...
	factory->new_parse_item(SCP_string("$Shockwave Evade Chances Per Second:"))
	...
	factory->new_parse_item(SCP_string("$Get Away Chance:"))
	...
	factory->new_parse_item(SCP_string("$Secondary Range Multiplier:"))
	...
	factory->new_parse_item(SCP_string("$Autoscale by AI Class Index:"))
	...
	factory->new_parse_item(SCP_string("$AI Countermeasure Firing Chance:"))
	...
	factory->new_parse_item(SCP_string("$AI In Range Time:"))
	...
	factory->new_parse_item(SCP_string("AI Always Links Ammo Weapons:"))
	...
	factory->new_parse_item(SCP_string("AI Maybe Links Ammo Weapons:"))
