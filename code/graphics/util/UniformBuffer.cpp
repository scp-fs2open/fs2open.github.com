...
UniformBuffer::UniformBuffer(UniformBufferManager* parent,
...
int UniformBuffer::bufferHandle() {
	return _buffer_handle;
}
size_t UniformBuffer::getBufferOffset(size_t localOffset) {
	return _parent_offset + localOffset;
}
size_t UniformBuffer::getAlignerElementOffset(size_t index) {
	return getBufferOffset(_aligner.getOffset(index));
}
size_t UniformBuffer::getCurrentAlignerOffset() {
	return getBufferOffset(_aligner.getCurrentOffset());
}
