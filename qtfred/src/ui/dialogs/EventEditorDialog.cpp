...
EventEditorDialog::EventEditorDialog(QWidget* parent, Editor* editor, FredRenderer* renderer) :
	QDialog(parent), ui(new Ui::EventEditorDialog()), _model(new EventEditorDialogModel(this, editor, renderer)) {
	ui->setupUi(this);
