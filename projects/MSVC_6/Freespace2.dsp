...
# ADD CPP /nologo /G5 /MT /W2 /GX /Zi /Ot /Ow /Oi /Oy /I "../../code" /I "../../oggvorbis/include" /I "../../dx8sdk/include" /I "../../lua" /I "../../openal/include" /D "_MBCS" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "USE_OPENAL" /U "_DEBUG" /FR /YX /FD /c
...
"$(FS2PATH)/fs2_open_3_6_9.exe" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(InputPath) "$(FS2PATH)/fs2_open_3_6_9.exe"
...
"$(FS2PATH)/fs2_open_3_6_9_debug.exe" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(InputPath) "$(FS2PATH)/fs2_open_3_6_9_debug.exe"
