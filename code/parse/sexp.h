...
#define OP_CONTAINER_DATA_INDEX				(0x0053 | OP_CATEGORY_STATUS | OP_NONCAMPAIGN_FLAG)	// Karajorma
#define OP_CONTAINER_HAS_KEY				(0x0054 | OP_CATEGORY_STATUS | OP_NONCAMPAIGN_FLAG)	// Karajorma
