...
#define OP_CONTAINER_HAS_DATA				(0x0059 | OP_CATEGORY_STATUS | OP_NONCAMPAIGN_FLAG)	// Karajorma
#define OP_CONTAINER_DATA_INDEX				(0x005a | OP_CATEGORY_STATUS | OP_NONCAMPAIGN_FLAG)	// Karajorma
#define OP_CONTAINER_HAS_KEY				(0x005b | OP_CATEGORY_STATUS | OP_NONCAMPAIGN_FLAG)	// Karajorma
