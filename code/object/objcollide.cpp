...
bool test_line_of_sight(vec3d* from, vec3d* to, std::unordered_set<const object*>&& excluded_objects, bool test_for_shields, bool test_for_hull, float* first_intersect_dist, float threshold) {
	bool collides = false;
