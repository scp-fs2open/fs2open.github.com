 ...
 *
 * @details This actually draws a a single oversized triangle that covers the screen in such a way so that the provided UV values are generated by the GPU in the corners of the screen. This is better than drawing two triangles since then the diagonal would be shaded differently for the two triangles causing visual differences.
 *
