...
public:
	...
	int	burst_seed[MAX_SHIP_PRIMARY_BANKS + MAX_SHIP_SECONDARY_BANKS];
	...
	// for type5 beams, keeps track of accumulated per burst rotation, added to with each burst (or shot if no burst)
	float per_burst_rot;
