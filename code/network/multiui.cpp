...
void multi_sg_init_gamenet()
{
	...
	// DISCUSSME: do we want security to remain within such a narrow range? Out of scope?
	Multi_sg_netgame->security = util::Random::next(32766) + 1;			// get some random security number	
	Multi_sg_netgame->mode = NG_MODE_OPEN;
