...
#define SEXP_CHECK_INVALID_LIST_MODIFIER		-164
#define SEXP_CHECK_WRONG_CONTAINER_TYPE			-165
#define SEXP_CHECK_WRONG_CONTAINER_DATA_TYPE	-166
#define SEXP_CHECK_WRONG_MAP_KEY_TYPE			-167
