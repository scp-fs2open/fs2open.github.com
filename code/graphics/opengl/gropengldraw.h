...
void gr_opengl_shadow_map_start(matrix4 *shadow_view_matrix, const matrix *light_orient, vec3d* eye_pos, bool render_cockpit_cascades, bool render_scene_cascades, bool first_pass);
